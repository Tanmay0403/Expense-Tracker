...
const AddBudget = ({ closePopup, handleBudget }) => {
  ...
  const saveBudget = () => {
    ...
    handleBudget(budgetAmount); // Update parent state
    closePopup();
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white flex flex-col gap-4 p-6 rounded-xl w-10/12 md:w-1/3 lg:w-1/4 shadow-lg">
        ...
        <div className="flex flex-col gap-4">
          ...
          />
          <button 
            className="bg-indigo-500 rounded-md w-full h-10 text-white font-bold text-xl"
            onClick={saveBudget}
          >
            Submit Budget
          </button>
